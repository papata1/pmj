...
@section('content')
        <div id="page">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">อนุมัติเป็นลูกหนี้
                                       ...
                                       <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                           ...
                                           <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $user->year}}  </td>
                                                            <td>
                                                            {{ link_to_route('Fund_debt_pass.edit','',[$user->id_r],['class'=>'btn btn-info glyphicon glyphicon-edit ']) }}
                                                            </td>
                                                    </tr>
                                                    @endforeach
                                           </tbody>
