    ...
    <div id="page">
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                       ...
                       <!-- /.row -->
                       {{ link_to_route('Fund_debt_pass.index','ย้อนกลับ',null,['class'=>'btn btn-default pull-right']) }}
                       <br />
                       <br />
                     ...
                     {{ link_to_route('Fund_borrowing.show','ข้อมูลบุคคล',[$service],['class'=>'btn btn-default']) }}
                            ...
                            {!! Form::model($service,array('route'=>['Fund_debt_pass.update',$service],'method'=>'PUT','novalidate' => 'novalidate','files' => true)) !!}
 @if($errors->any())
