...
@section('content')
    <div id="page">
            <div class="row">
              ...
              <a href="Fund_debt_record.php" class="btn btn-success fa fa-list-alt"> ลงบันทึกการติดตามทวงถามหนี้ค้างชำระ</a>
            </div>
            <br /><br /><br />
                  <!-- /.col-lg-12 -->
                </div><!-- /row -->
                  ...
                  <div class="panel-heading">
                      ...
                      <div class="col-md-2">
                        บันทึกติดตามทวงถามหนี้
                          ...
                          <a href="../file/บันทึกการติดตามทวงถามหนี้ค้างชำระกองทุนผู้สูงอายุ.docx" class="btn btn-primary fa fa-print"> บันทึกการติดตามถามทวงหนี้</a>
                        </div>
                  <!-- /.panel-heading -->
                  <div class="panel-body">
