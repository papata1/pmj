...
<script>
    $(document).ready(function() {
        ...
        $('#cost').on('click',function(){
            ...
            i++;
            phpVal++;
        text = " <label class='col-lg-1'>&nbsp;&nbsp;&nbsp;&nbsp;" + phpVal + ".</label> <input type='text' class='col-lg-4'  name='name_l" + phpVal + "' id='' /> <label class='col-lg-1' > </label> <input type='text' class='col-lg-4'  name='cost_l" + phpVal + "' id=''/>  <label class='col-lg-2' >บาท</label> <div class='col-lg-12'> <br />  </div> <div class=cost2> </div> ";
