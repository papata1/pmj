            ...
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                       ...
                       <div class="row">
                                   ...
                                   <!-- /.panel-heading -->
                                     ...
                                     <div class="form-group col-lg-6">
                                       ...
                                       <div class="col-lg-5">
                                        ...
                                        <input type="file" class="col-lg-9" >
                                        <div class="col-lg-12"> <br />  </div>
                                        <div class="col-lg-12"> <br />  </div>
                           ...
                           <div class="col-lg-10">
                           <input type="radio" name="gender"  /><span> บุตร&nbsp;&nbsp;</span>
                           <input type="radio" name="gender" /><span> ญาติ&nbsp;&nbsp;</span>
                           <input type="radio" name="gender" /><span> คนรู้จัก/เพื่อนบ้าน&nbsp;&nbsp;</span>
                           </div>
                           <div class="col-lg-12"> <br />  </div>
                           ...
                           <div class="col-lg-10">
                           <input type="radio" name="life" checked /><span> ยังมีชีวิตอยู่&nbsp;&nbsp;</span>
                           <input type="radio" name="life" /><span> เสียชีวิต&nbsp;&nbsp;</span>
                           </div>
                         ...
                         <label class="col-lg-2 ">ชื่อบิดา</label>
                         <input type="text" class="col-lg-3"  />
                         <label  class="col-lg-2 text-right">ชื่อมารดา</label>
                         <div class="col-lg-5">
                         <input type="text" class="col-lg-8" />
                         </div>
                         <div class="col-lg-12"> <br />  </div>
