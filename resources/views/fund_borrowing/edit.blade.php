...
@section('content')
    <div id="page">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">แก้ไขข้อมูลงานกู้ยืมเงินผู้สูงอายุ</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                       <!-- /.row -->
                                    ...
                                    @endif
                                      ...
                                      <div class="col-lg-12"> </div>
                                       ...
                                       <input type="radio" class="prefix" id="prefix" name="prefix" value="นางสาว" @if($service->prefix=='นางสาว')checked="checked"@endif/><span> นางสาว&nbsp;&nbsp;</span>
                                        ...
                                        @elseif($service->prefix!='นางสาว' && $service->prefix!='นาง' && $service->prefix!='นาย')
                                      ...
                                      @if($service->live_cate=='')
                                       <input type="radio"  id="live_cate1" name="live_cate"  /><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text" id="live_cate11" name="live_cate" disabled/>
                                      @elseif($service->live_cate!='บ้าน' && $service->live_cate!='ทาวน์เฮาส์' && $service->live_cate!='คอนโดมิเนียม' && $service->live_cate!='อพาร์ทเม้นท์หอพักแฟลต')
                                      ...
                                      <input type="radio" id="s_status" name="m_status"  value="โสด" @if($service->m_status=='โสด') checked="checked" @endif/> <span> โสด&nbsp;&nbsp;</span>
                                       ...
                                       @elseif($ser->prefix!='นางสาว' && $ser->prefix!='นาง' && $ser->prefix!='นาย')
                                       ...
                                       <input type="text" class="col-lg-8" id="income" name="income" value="{{$ser->income}}"/>
                                        ...
                                        <input list="browsers" name="forwhat"class="col-lg-3" value="{{$ser->forwhat}}" />
                                        ...
                                        <div class="col-lg-4">
                                       <input type="text" class="col-lg-8"  name="job_remark" value="{{$ser->job_remark}}"/>
                                       </div>
                                        <div class="col-lg-12"> <br />  </div>
...
<!-----------------------------------------------------------------------------------------------------------------------------------------------!-->
                           ...
                           <div class="col-lg-12"> <br />  </div>
                                          ...
                                          <div class="col-lg-6" >
                                           <label >เลขบัตรประชาชนประจำตัว</label>
                                           <input type="text" id="id_p_b1" name="id_p2" value="{{$ser2->id_p}}" />
                                         <!--   <button  value="ตรวจสอบ" id="ck_id1" type="button" ><i >ตรวจสอบ</i></button>!-->
                                          </div>

                                       <div class="col-lg-6">
                                           <label>บัตรหมดอายุวันที่</label>
                                           <input type="date"  id="id_exp5" name="id_exp2" value="{{$ser2->id_exp}}"@if($ser2->id_exp=='ตลอดชีวิต')  disabled="disabled"@endif/>&nbsp;&nbsp;
                                           <input type="checkbox" id="id_exp6" name="id_exp2" value="ตลอดชีวิต" @if($ser2->id_exp=='ตลอดชีวิต')  checked="checked"@endif />
                                           <span>ตลอดชีวิต</span>
                                       </div>
                                       <div class="col-lg-12"> <br />  </div>
                                       ...
                                       <label class="col-lg-2">คำนำหน้าชื่อ</label>
                                       <div class="col-lg-10">
                                       <input type="radio" class="check" id="prefix" name="prefix2" value="นาย" @if($ser2->prefix=='นาย')checked="checked"@endif/><span> นาย&nbsp;&nbsp;</span>
                                       <input type="radio" class="check" id="prefix" name="prefix2" value="นาง" @if($ser2->prefix=='นาง')checked="checked"@endif/><span> นาง&nbsp;&nbsp;</span>
                                       <input type="radio" class="check" id="prefix" name="prefix2" value="นางสาว" @if($ser2->prefix=='นางสาว')checked="checked"@endif/><span> นางสาว&nbsp;&nbsp;</span>
                                         @if($ser2->prefix=='')
                                                                              <input type="radio"  class='checked' id="prefix12" name="prefix2"  /><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text"  id="prefix123" name="prefix1"  class='checkedinput' disabled />

                                       @elseif($ser2->prefix!='นางสาว' && $ser2->prefix!='นาง' && $ser2->prefix!='นาย')
                                       <input type="radio"  class='checked' id="prefix12" name="prefix2" checked="checked" /><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text"  id="prefix123" name="prefix2"  class='checkedinput' value="{{$ser2->prefix}}"  />
                                                                              @endif
                                       </div>
                                       <div class="col-lg-12"> <br />  </div>
                                      ...
                                      <div class="col-lg-12"> <br />  </div>
                                       ...
                                       <label class="col-lg-2">ประเภทที่อยู่</label>
                                       <div class="col-lg-10">
                                       <input type="radio" class="live_cate7" id="live_cate" name="live_cate1" value="บ้าน" @if($ser2->live_cate=='บ้าน')checked="checked"@endif/><span> บ้าน&nbsp;&nbsp;</span>
                                       <input type="radio" class="live_cate7" id="live_cate" name="live_cate1" value="ทาวน์เฮาส์" @if($ser2->live_cate=='ทาวน์เฮาส์')checked="checked"@endif/><span> ทาวน์เฮาส์&nbsp;&nbsp;</span>
                                       <input type="radio" class="live_cate7" id="live_cate" name="live_cate1" value="คอนโดมิเนียม" @if($ser2->live_cate=='คอนโดมิเนียม')checked="checked"@endif/><span> คอนโดมิเนียม&nbsp;&nbsp;</span>
                                       <input type="radio" class="live_cate7" id="live_cate" name="live_cate1" value="อพาร์ทเม้นท์หอพักแฟลต" @if($ser2->live_cate=='อพาร์ทเม้นท์หอพักแฟลต')checked="checked"@endif/><span> อพาร์ทเม้นท์/หอพัก/แฟลต&nbsp;&nbsp;</span>
                                       @if($ser2->live_cate=='' )
                                        <input type="radio"  id="live_cate6" name="live_cate1"  /><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text" id="live_cate66" name="live_cate1" disabled/>
                                       @elseif($ser2->live_cate!='บ้าน' && $ser2->live_cate!='ทาวน์เฮาส์' && $ser2->live_cate!='คอนโดมิเนียม' && $ser2->live_cate!='อพาร์ทเม้นท์หอพักแฟลต')
                                       <input type="radio"  id="live_cate6" name="live_cate1"  checked="checked"/><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text" id="live_cate66" name="live_cate1" value="{{$service->live_cate}}"/>
                                       ...
                                       <div class="col-lg-2"></div>
                                       <div class="col-lg-10">
                                         <input type="radio" class='live_status1' id="live_status" name="live_status1" value="เป็นของบุคคลอื่น"@if($ser2->live_status=='เป็นของบุคคลอื่น')checked="checked"@endif/><span> เป็นของบุคคลอื่น&nbsp;&nbsp;</span>
                                         <input type="radio" class='live_status1' id="live_status" name="live_status1" value="อาศัยอยู่กับบุตรหลานญาติ"@if($ser2->live_status=='เป็นของบุคคลอื่น')checked="checked"@endif/><span> อาศัยอยู่กับบุตรหลาน/ญาติ&nbsp;&nbsp;</span>
                                         <input type="radio" class='live_status1' id="live_status" name="live_status1" value="บ้านพักสวัสดิการ"@if($ser2->live_status=='เป็นของบุคคลอื่น')checked="checked"@endif/><span> บ้านพักสวัสดิการ&nbsp;&nbsp;</span>
 ...
 <!-----------------------------------------------------------------------------------------------------------------------------------------------!-->
                           ...
                           <h4><label class="col-lg-12 "  >ข้อมูลทายาท</label></h4>
                                      ...
                                      <div class="col-lg-6">
                                       ...
                                       <div class="col-lg-6">
                                       <label>บัตรหมดอายุวันที่</label>
                                           <input type="date"  id="id_exp7" name="id_exp5" value="{{$ser4->id_exp}}"@if($ser4->id_exp=='ตลอดชีวิต')  disabled="disabled"@endif/>&nbsp;&nbsp;
                                           <input type="checkbox" id="id_exp8" name="id_exp5" value="ตลอดชีวิต"  @if($ser4->id_exp=='ตลอดชีวิต')  checked="checked"@endif/>
                                           <span>ตลอดชีวิต</span>
                                       </div>
                                       <div class="col-lg-12"> <br />  </div>
                                       ...
                                       <input type="radio" class="prefix2" id="prefix" name="prefix5" value="นางสาว" @if($ser4->prefix=='นางสาว')checked="checked"@endif/><span> นางสาว&nbsp;&nbsp;</span>
                                        ...
                                        @elseif($ser4->prefix!='นางสาว' && $ser4->prefix!='นาง' && $ser4->prefix!='นาย')
                                       <input type="radio" id="prefix4" name="prefix5" checked /><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text" id="prefix5" name="prefix5" value="{{$ser4->prefix}}" />
                                       @endif
                                       </div>
                                       <div class="col-lg-12"> <br />  </div>
                                      ...
                                      <div class="col-lg-12"> <br />  </div>
                                       ...
                                       <label class="col-lg-2">ประเภทที่อยู่</label>
                                       <div class="col-lg-10">
                                       <input type="radio" class="live_cate2" id="live_cate" name="live_cate5" value="บ้าน" @if($ser4->live_cate=='บ้าน')checked="checked"@endif  /><span> บ้าน&nbsp;&nbsp;</span>
                                       <input type="radio" class="live_cate2" id="live_cate" name="live_cate5" value="ทาวน์เฮาส์" @if($ser4->live_cate=='ทาวน์เฮาส์')checked="checked"@endif/><span> ทาวน์เฮาส์&nbsp;&nbsp;</span>
                                       <input type="radio" class="live_cate2" id="live_cate" name="live_cate5" value="คอนโดมิเนียม" @if($ser4->live_cate=='คอนโดมิเนียม')checked="checked"@endif/><span> คอนโดมิเนียม&nbsp;&nbsp;</span>
                                       <input type="radio" class="live_cate2" id="live_cate" name="live_cate5" value="อพาร์ทเม้นท์หอพักแฟลต" @if($ser4->live_cate=='อพาร์ทเม้นท์หอพักแฟลต')checked="checked"@endif/><span> อพาร์ทเม้นท์/หอพัก/แฟลต&nbsp;&nbsp;</span>
                                        @if($ser4->live_cate=='')
                                        <input type="radio"  id="live_cate4" name="live_cate5"  /><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text" id="live_cate5" name="live_cate5" disabled/>
                                        @elseif($ser4->live_cate!='บ้าน' && $ser4->live_cate!='ทาวน์เฮาส์' && $ser4->live_cate!='คอนโดมิเนียม' && $ser4->live_cate!='อพาร์ทเม้นท์หอพักแฟลต')
                                       <input type="radio"  id="live_cate4" name="live_cate5" checked /><span> อื่นๆ&nbsp;&nbsp;</span>    <input type="text" id="live_cate5" name="live_cate5" value="{{$ser4->live_cate}}"/>
                                       @endif
                                       </div>
                                       <div class="col-lg-12"> <br />  </div>
                                       ...
                                       <div class="col-lg-2"></div>
                                       <div class="col-lg-10">
                                         <input type="radio" class='live_status2' id="live_status" name="live_status5" value="เป็นของบุคคลอื่น" @if($ser5->live_status=='เป็นของบุคคลอื่น')checked="checked"@endif/><span> เป็นของบุคคลอื่น&nbsp;&nbsp;</span>
                                         <input type="radio" class='live_status2' id="live_status" name="live_status5" value="อาศัยอยู่กับบุตรหลานญาติ" @if($ser5->live_status=='อาศัยอยู่กับบุตรหลานญาติ')checked="checked"@endif/><span> อาศัยอยู่กับบุตรหลาน/ญาติ&nbsp;&nbsp;</span>
                                         <input type="radio" class='live_status2' id="live_status" name="live_status5" value="บ้านพักสวัสดิการ" @if($ser5->live_status=='บ้านพักสวัสดิการ')checked="checked"@endif/><span> บ้านพักสวัสดิการ&nbsp;&nbsp;</span>
...
//--------------------------------------------------------------------------------------------------------------
       ...
       var val = '<?php echo $service->check_live ;?>';
        var val1 = '<?php echo $ser2->check_live ;?>';
         ...
         var val3 = '<?php echo $service->m_status ;?>';
...
function isNumber(obj) { return !isNaN(parseFloat(obj)) };
           ...
           var val = <?php echo json_encode($ck_id ); ?>;
        var c = val.length;
        $('#ck_id').on('click',function(){
         ...
         var val1 = <?php echo json_encode($ck_id ); ?>;
        var c1 = val1.length;
        $('#ck_id1').on('click',function(){
            ...
            for (i = 0; i < val.length; i++) {
              if(val1[i] == $('#id_p_b1').val()){
                ...
                alert('หมายเลขบัตรประชาชนต้องเป็นตัวเลขเท่านั้น');
                 }
            }else{
                alert('หมายเลขบัตรประชาชนต้องมี13หลัก');
            }
