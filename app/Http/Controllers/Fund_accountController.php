  ...
  public function __construct()
  {
    ...
    public function index(){
     ...
     // return view('service.index',compact('ser'));
      return view('Fund_account.index');
    }
    ...
    /* $u = department::create([
        ...
        return redirect()->route('Fund_account.index')->with('message','item has been added successfully');
     }
    ...
    {
        return view('Fund_account.edit',compact('service'));
    }
    ...
    public function update(ServiceRequest $request,Service $service)
   {
    //  $affectedRows = de::where('id',$de->id)->update(['name' => $de->name,'email' => $de->email,'role' => $de->role ]);
      /*$ue =   DB::table('des')
       ...
       return redirect()->route('Fund_account.index')->with('message','item has been updated successfully');
   }
