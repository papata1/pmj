  ...
  public function __construct()
  {
    ...
    public function index(){
     ...
     // return view('service.index',compact('ser'));
      return view('Fund_account_bill.index');
    }
    ...
    {
        return view('Fund_account_bill.edit',compact('service'));
    }
    ...
    public function update(ServiceRequest $request,Service $service)
   {
    //  $affectedRows = de::where('id',$de->id)->update(['name' => $de->name,'email' => $de->email,'role' => $de->role ]);
     ...
     {
        $service->delete();
        return redirect()->route('Fund_account_bill.index')->with('message','item has been deleted successfully');
     }
}
