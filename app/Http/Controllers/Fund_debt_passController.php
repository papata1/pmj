  ...
  public function __construct()
  {
    ...
    public function index(){
     ...
     // return view('service.index',compact('ser'));
      return view('Fund_debt_pass.index');
    }
    public function create(){
    return view('Fund_debt_pass.create');
    }
    ...
    {
        return view('Fund_debt.edit_pass',compact('service'));
    }
    ...
    public function update(ServiceRequest $request,Service $service)
   {
    //  $affectedRows = de::where('id',$de->id)->update(['name' => $de->name,'email' => $de->email,'role' => $de->role ]);
      /*$ue =   DB::table('des')
       ...
       $service->update($request->pass());
       return redirect()->route('Fund_debt.index_pass')->with('message','item has been updated successfully');
   }
